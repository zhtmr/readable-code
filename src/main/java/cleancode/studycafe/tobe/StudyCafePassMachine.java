...
public class StudyCafePassMachine {
  ...
  public void run() {
    try {
      ...
      outputHandler.showPassOrderSummary(selectedPass, optionalLockerPass.orElse(null));
  ...
  private StudyCafeLockerPass findLockerPassCandidateBy(StudyCafePass pass) {
    ...
    return allLockerPasses
      .stream()
      .filter(
        lockerPass -> lockerPass.getPassType() == pass.getPassType() && lockerPass.getDuration() == pass.getDuration())
      .findFirst()
      .orElse(null);
  }
